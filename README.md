...
Configaudit is a defensive cybersecurity and system-administration project written in Stable Rust. It focuses on read-only analysis, validation, clear output, and safe handling of user-provided files, URLs, hosts, or text.
